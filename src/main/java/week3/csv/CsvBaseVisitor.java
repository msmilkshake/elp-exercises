...
public class CsvBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CsvVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitBool(CsvParser.BoolContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitNumber(CsvParser.NumberContext ctx) { return visitChildren(ctx); }
}